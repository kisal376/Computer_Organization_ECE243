...
void animate_line(int x1, int y1, int x2, int y2, short int line_color);
...
int main(void)
{
  ...
  animate_line (100, 150, 200, 150, 0xF800);
  ...
  while(true){
    ...
    *pixel_ctrl_ptr = 1;
    ...
    while ((status & 0x01) != 0){
      ...
      draw_line(x1, current_y1, x2, current_y2, 0);
      current_y1 = current_y1 + step_y1;
      current_y2 = current_y2 + step_y2;
      draw_line(x1, current_y1, x2, current_y2, line_color);
  }
}
